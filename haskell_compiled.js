...
{var location = hoogle_doc.location;var vec__7404 = /http:\/\/hackage.haskell.org\/packages\/archive\/(.+)\/latest\/doc\/html\/(.+).html/.exec(location);var _ = cljs.core.nth.call(null,vec__7404,0,null);var doc_package = cljs.core.nth.call(null,vec__7404,1,null);var doc_raw_module = cljs.core.nth.call(null,vec__7404,2,null);var doc_module = (cljs.core.truth_(doc_raw_module)?doc_raw_module.replace("-","."):"");return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1017277949),hoogle_doc.self,new cljs.core.Keyword(null,"ns","ns",1013907767),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",1013904339),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",1017115293),location], null),[cljs.core.str("Hoogle ("),cljs.core.str(doc_package),cljs.core.str(": "),cljs.core.str(doc_module),cljs.core.str(")")].join('')], null),new cljs.core.Keyword(null,"doc","doc",1014003882),hoogle_doc.docs], null);
}
});
...
lt.plugins.haskell.__BEH__editor_reformat_file_result = (function __BEH__editor_reformat_file_result(editor,result){return lt.plugins.haskell.replace_buffer.call(null,new cljs.core.Keyword(null,"code","code",1016963423).cljs$core$IFn$_invoke$arity$1(result));
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.haskell","editor-reformat-file-result","lt.plugins.haskell/editor-reformat-file-result",2582205581),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.haskell.__BEH__editor_reformat_file_result,new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"editor.haskell.reformat.result","editor.haskell.reformat.result",3863060632),null], null), null));

lt.plugins.haskell.__BEH__haskell_reformat_file = (function __BEH__haskell_reformat_file(editor){return lt.object.raise.call(null,lt.plugins.haskell.haskell,new cljs.core.Keyword(null,"haskell.send.reformat.file","haskell.send.reformat.file",2870169286),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"origin","origin",4300251800),editor], null));
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.haskell","haskell-reformat-file","lt.plugins.haskell/haskell-reformat-file",1962970856),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.haskell.__BEH__haskell_reformat_file,new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"haskell.reformat.file","haskell.reformat.file",3121107448),null], null), null));

lt.plugins.haskell.__BEH__haskell_send_reformat_file = (function __BEH__haskell_send_reformat_file(this$,event){var map__7406 = event;var map__7406__$1 = ((cljs.core.seq_QMARK_.call(null,map__7406))?cljs.core.apply.call(null,cljs.core.hash_map,map__7406):map__7406);var origin = cljs.core.get.call(null,map__7406__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__7406__$1,new cljs.core.Keyword(null,"info","info",1017141280));var client = new cljs.core.Keyword(null,"default","default",2558708147).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"client","client",3951159101).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,origin)));lt.objs.notifos.working.call(null,"");
return lt.objs.clients.send.call(null,lt.objs.eval.get_client_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"haskell.reformat","haskell.reformat",1972259350),new cljs.core.Keyword(null,"origin","origin",4300251800),origin,new cljs.core.Keyword(null,"info","info",1017141280),info,new cljs.core.Keyword(null,"create","create",3956577390),lt.plugins.haskell.try_connect], null)),new cljs.core.Keyword(null,"haskell.reformat","haskell.reformat",1972259350),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"data","data",1016980252),lt.plugins.haskell.current_buffer_content.call(null)], null),new cljs.core.Keyword(null,"only","only",1017320222),origin);
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.haskell","haskell-send-reformat-file","lt.plugins.haskell/haskell-send-reformat-file",3554699253),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.haskell.__BEH__haskell_send_reformat_file,new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"haskell.send.reformat.file","haskell.send.reformat.file",2870169286),null], null), null));
...
{var ed = temp__4092__auto__;return lt.object.raise.call(null,ed,new cljs.core.Keyword(null,"haskell.reformat.file","haskell.reformat.file",3121107448));
} else
{return null;
}
})], null));
...
lt.plugins.haskell.run_haskell = (function run_haskell(p__7407){var map__7409 = p__7407;var map__7409__$1 = ((cljs.core.seq_QMARK_.call(null,map__7409))?cljs.core.apply.call(null,cljs.core.hash_map,map__7409):map__7409);var info = map__7409__$1;var client = cljs.core.get.call(null,map__7409__$1,new cljs.core.Keyword(null,"client","client",3951159101));var name = cljs.core.get.call(null,map__7409__$1,new cljs.core.Keyword(null,"name","name",1017277949));var path = cljs.core.get.call(null,map__7409__$1,new cljs.core.Keyword(null,"path","path",1017337751));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.haskell","connecting-notifier","lt.plugins.haskell/connecting-notifier",4244447005),info);var client_id = lt.objs.clients.__GT_id.call(null,client);lt.object.merge_BANG_.call(null,client,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"port","port",1017351155),lt.objs.clients.tcp.port,new cljs.core.Keyword(null,"proc","proc",1017353928),obj], null));
...
lt.plugins.haskell.notify = (function notify(obj){var map__7411 = obj;var map__7411__$1 = ((cljs.core.seq_QMARK_.call(null,map__7411))?cljs.core.apply.call(null,cljs.core.hash_map,map__7411):map__7411);var client = cljs.core.get.call(null,map__7411__$1,new cljs.core.Keyword(null,"client","client",3951159101));var path = cljs.core.get.call(null,map__7411__$1,new cljs.core.Keyword(null,"path","path",1017337751));var haskell = cljs.core.get.call(null,map__7411__$1,new cljs.core.Keyword(null,"haskell","haskell",1711527270));if((cljs.core.not.call(null,haskell)) || (cljs.core.empty_QMARK_.call(null,haskell)))
...
lt.plugins.haskell.try_connect = (function try_connect(p__7412){var map__7414 = p__7412;var map__7414__$1 = ((cljs.core.seq_QMARK_.call(null,map__7414))?cljs.core.apply.call(null,cljs.core.hash_map,map__7414):map__7414);var info = cljs.core.get.call(null,map__7414__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"haskell.client","haskell.client",4292563063));lt.plugins.haskell.check_all.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",1017337751),path,new cljs.core.Keyword(null,"client","client",3951159101),client], null));
return client;
});
