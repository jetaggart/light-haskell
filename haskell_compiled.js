...
lt.plugins.haskell.__BEH__editor_syntax_result = (function __BEH__editor_syntax_result(editor,result){return cljs.core.println.call(null,result.call(null,new cljs.core.Keyword(null,"data","data",1016980252)));
});
...
lt.plugins.haskell.__BEH__haskell_send_reformat = (function __BEH__haskell_send_reformat(this$,event){var map__7382 = event;var map__7382__$1 = ((cljs.core.seq_QMARK_.call(null,map__7382))?cljs.core.apply.call(null,cljs.core.hash_map,map__7382):map__7382);var origin = cljs.core.get.call(null,map__7382__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__7382__$1,new cljs.core.Keyword(null,"info","info",1017141280));var client = new cljs.core.Keyword(null,"default","default",2558708147).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"client","client",3951159101).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,origin)));lt.objs.notifos.working.call(null,"");
...
lt.plugins.haskell.run_haskell = (function run_haskell(p__7383){var map__7385 = p__7383;var map__7385__$1 = ((cljs.core.seq_QMARK_.call(null,map__7385))?cljs.core.apply.call(null,cljs.core.hash_map,map__7385):map__7385);var info = map__7385__$1;var client = cljs.core.get.call(null,map__7385__$1,new cljs.core.Keyword(null,"client","client",3951159101));var name = cljs.core.get.call(null,map__7385__$1,new cljs.core.Keyword(null,"name","name",1017277949));var path = cljs.core.get.call(null,map__7385__$1,new cljs.core.Keyword(null,"path","path",1017337751));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.haskell","connecting-notifier","lt.plugins.haskell/connecting-notifier",4244447005),info);var client_id = lt.objs.clients.__GT_id.call(null,client);lt.object.merge_BANG_.call(null,client,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"port","port",1017351155),lt.objs.clients.tcp.port,new cljs.core.Keyword(null,"proc","proc",1017353928),obj], null));
...
lt.plugins.haskell.notify = (function notify(obj){var map__7387 = obj;var map__7387__$1 = ((cljs.core.seq_QMARK_.call(null,map__7387))?cljs.core.apply.call(null,cljs.core.hash_map,map__7387):map__7387);var client = cljs.core.get.call(null,map__7387__$1,new cljs.core.Keyword(null,"client","client",3951159101));var path = cljs.core.get.call(null,map__7387__$1,new cljs.core.Keyword(null,"path","path",1017337751));var haskell = cljs.core.get.call(null,map__7387__$1,new cljs.core.Keyword(null,"haskell","haskell",1711527270));if((cljs.core.not.call(null,haskell)) || (cljs.core.empty_QMARK_.call(null,haskell)))
...
lt.plugins.haskell.try_connect = (function try_connect(p__7388){var map__7390 = p__7388;var map__7390__$1 = ((cljs.core.seq_QMARK_.call(null,map__7390))?cljs.core.apply.call(null,cljs.core.hash_map,map__7390):map__7390);var info = cljs.core.get.call(null,map__7390__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"haskell.client","haskell.client",4292563063));lt.plugins.haskell.check_all.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",1017337751),path,new cljs.core.Keyword(null,"client","client",3951159101),client], null));
return client;
});
