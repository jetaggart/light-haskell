...
lt.plugins.haskell.convert_response = (function convert_response(response){cljs.core.println.call(null,response);
var results = response.getResponseJson().results;return cljs.core.map.call(null,lt.plugins.haskell.convert_doc_result,results);
});

lt.plugins.haskell.handle_hoogle_response = (function handle_hoogle_response(event){var response = event.target;if(cljs.core.truth_(response.isSuccess()))
{return lt.object.raise.call(null,lt.plugins.doc.doc_search,new cljs.core.Keyword(null,"doc.search.results","doc.search.results",3363305624),lt.plugins.haskell.convert_response.call(null,response));
} else
{return lt.objs.notifos.done_working.call(null,"Failed to contact hoogle. Please try again");
}
});
