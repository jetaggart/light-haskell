...
lt.plugins.haskell.lt_haskell_path = lt.plugins.haskell.escape_spaces.call(null,lt.objs.files.join.call(null,lt.objs.plugins._STAR_plugin_dir_STAR_,"haskell/LTHaskellClient.hs"));

lt.plugins.haskell.open_port = (function open_port(id,cb){return lt.plugins.haskell.harbor.claim([cljs.core.str(id)].join(''),(function (p1__7224_SHARP_,p2__7223_SHARP_){return cb.call(null,p2__7223_SHARP_);
}));
});
...
lt.plugins.haskell.try_connect = (function try_connect(p__7225){var map__7227 = p__7225;var map__7227__$1 = ((cljs.core.seq_QMARK_.call(null,map__7227))?cljs.core.apply.call(null,cljs.core.hash_map,map__7227):map__7227);var info = cljs.core.get.call(null,map__7227__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"haskell.client","haskell.client",4292563063));lt.plugins.haskell.check_all.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",1017337751),path,new cljs.core.Keyword(null,"client","client",3951159101),client], null));
return client;
});

lt.plugins.haskell.run_haskell = (function run_haskell(p__7228){var map__7230 = p__7228;var map__7230__$1 = ((cljs.core.seq_QMARK_.call(null,map__7230))?cljs.core.apply.call(null,cljs.core.hash_map,map__7230):map__7230);var info = map__7230__$1;var client = cljs.core.get.call(null,map__7230__$1,new cljs.core.Keyword(null,"client","client",3951159101));var name = cljs.core.get.call(null,map__7230__$1,new cljs.core.Keyword(null,"name","name",1017277949));var path = cljs.core.get.call(null,map__7230__$1,new cljs.core.Keyword(null,"path","path",1017337751));return lt.plugins.haskell.open_port.call(null,lt.objs.clients.__GT_id.call(null,client),(function (port){var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.haskell","connecting-notifier","lt.plugins.haskell/connecting-notifier",4244447005),info);cljs.core.println.call(null,client);
lt.object.merge_BANG_.call(null,client,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"port","port",1017351155),port,new cljs.core.Keyword(null,"proc","proc",1017353928),obj], null));
lt.objs.notifos.working.call(null,"Connecting..");
return proc.exec.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"command","command",1964298941),"runhaskell",new cljs.core.Keyword(null,"args","args",1016906831),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [lt.plugins.haskell.lt_haskell_path,tcp.port,lt.objs.clients.__GT_id.call(null,client)], null),new cljs.core.Keyword(null,"cwd","cwd",1014003170),lt.objs.files.parent.call(null,path),new cljs.core.Keyword(null,"env","env",1014004831),new cljs.core.PersistentArrayMap(null, 1, ["HASKELL_PATH",lt.objs.files.join.call(null,lt.objs.files.parent.call(null,path))], null),new cljs.core.Keyword(null,"obj","obj",1014014057),obj], null));
}));
});

lt.plugins.haskell.check_haskell = (function check_haskell(_){return cljs.core.assoc.call(null,lt.plugins.haskell.obj,new cljs.core.Keyword(null,"haskell","haskell",1711527270),lt.plugins.haskell.shell.which("runhaskell"));
});
...
lt.plugins.haskell.__BEH__connect = (function __BEH__connect(this$,path){cljs.core.println.call(null,"This is trying to connect");
return lt.plugins.haskell.try_connect.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"info","info",1017141280),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"path","path",1017337751),path], null)], null));
});
