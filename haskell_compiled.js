...
lt.plugins.haskell.print_syntax_errors = (function print_syntax_errors(editor,data){var seq__8091 = cljs.core.seq.call(null,data);var chunk__8092 = null;var count__8093 = 0;var i__8094 = 0;while(true){
...
{
var G__8107 = seq__8091;
var G__8108 = chunk__8092;
var G__8109 = count__8093;
var G__8110 = (i__8094 + 1);
seq__8091 = G__8107;
chunk__8092 = G__8108;
count__8093 = G__8109;
i__8094 = G__8110;
...
var G__8111 = cljs.core.chunk_rest.call(null,seq__8091__$1);
var G__8112 = c__6528__auto__;
var G__8113 = cljs.core.count.call(null,c__6528__auto__);
var G__8114 = 0;
seq__8091 = G__8111;
chunk__8092 = G__8112;
count__8093 = G__8113;
...
{
var G__8115 = cljs.core.next.call(null,seq__8091__$1);
var G__8116 = null;
var G__8117 = 0;
var G__8118 = 0;
seq__8091 = G__8115;
...
lt.plugins.haskell.__BEH__haskell_send_reformat = (function __BEH__haskell_send_reformat(this$,event){var map__8098 = event;var map__8098__$1 = ((cljs.core.seq_QMARK_.call(null,map__8098))?cljs.core.apply.call(null,cljs.core.hash_map,map__8098):map__8098);var origin = cljs.core.get.call(null,map__8098__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__8098__$1,new cljs.core.Keyword(null,"info","info",1017141280));var client = new cljs.core.Keyword(null,"default","default",2558708147).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"client","client",3951159101).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,origin)));lt.objs.notifos.working.call(null,"");
...
lt.plugins.haskell.run_haskell = (function run_haskell(p__8099){var map__8101 = p__8099;var map__8101__$1 = ((cljs.core.seq_QMARK_.call(null,map__8101))?cljs.core.apply.call(null,cljs.core.hash_map,map__8101):map__8101);var info = map__8101__$1;var client = cljs.core.get.call(null,map__8101__$1,new cljs.core.Keyword(null,"client","client",3951159101));var name = cljs.core.get.call(null,map__8101__$1,new cljs.core.Keyword(null,"name","name",1017277949));var path = cljs.core.get.call(null,map__8101__$1,new cljs.core.Keyword(null,"path","path",1017337751));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.haskell","connecting-notifier","lt.plugins.haskell/connecting-notifier",4244447005),info);var client_id = lt.objs.clients.__GT_id.call(null,client);lt.object.merge_BANG_.call(null,client,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"port","port",1017351155),lt.objs.clients.tcp.port,new cljs.core.Keyword(null,"proc","proc",1017353928),obj], null));
...
lt.plugins.haskell.notify = (function notify(obj){var map__8103 = obj;var map__8103__$1 = ((cljs.core.seq_QMARK_.call(null,map__8103))?cljs.core.apply.call(null,cljs.core.hash_map,map__8103):map__8103);var client = cljs.core.get.call(null,map__8103__$1,new cljs.core.Keyword(null,"client","client",3951159101));var path = cljs.core.get.call(null,map__8103__$1,new cljs.core.Keyword(null,"path","path",1017337751));var haskell = cljs.core.get.call(null,map__8103__$1,new cljs.core.Keyword(null,"haskell","haskell",1711527270));if((cljs.core.not.call(null,haskell)) || (cljs.core.empty_QMARK_.call(null,haskell)))
...
lt.plugins.haskell.try_connect = (function try_connect(p__8104){var map__8106 = p__8104;var map__8106__$1 = ((cljs.core.seq_QMARK_.call(null,map__8106))?cljs.core.apply.call(null,cljs.core.hash_map,map__8106):map__8106);var info = cljs.core.get.call(null,map__8106__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"haskell.client","haskell.client",4292563063));lt.plugins.haskell.check_all.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",1017337751),path,new cljs.core.Keyword(null,"client","client",3951159101),client], null));
return client;
});
