...
{var location = hoogle_doc.location;var vec__8349 = /http:\/\/hackage.haskell.org\/packages\/archive\/(.+)\/latest\/doc\/html\/(.+).html/.exec(location);var with_mod = cljs.core.nth.call(null,vec__8349,0,null);var mod_package = cljs.core.nth.call(null,vec__8349,1,null);var module_name = cljs.core.nth.call(null,vec__8349,2,null);var explanation = (((with_mod == null))?"":[cljs.core.str(" ("),cljs.core.str(mod_package),cljs.core.str(": "),cljs.core.str(clojure.string.replace.call(null,module_name,"-",".")),cljs.core.str(")")].join(''));return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1017277949),hoogle_doc.self,new cljs.core.Keyword(null,"ns","ns",1013907767),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",1013904339),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",1017115293),location], null),[cljs.core.str("Hoogle"),cljs.core.str(explanation)].join('')], null),new cljs.core.Keyword(null,"doc","doc",1014003882),hoogle_doc.docs], null);
}
});
...
lt.plugins.haskell.print_inline_errors = (function print_inline_errors(editor,data){var seq__8354 = cljs.core.seq.call(null,data);var chunk__8355 = null;var count__8356 = 0;var i__8357 = 0;while(true){
if((i__8357 < count__8356))
{var error = cljs.core._nth.call(null,chunk__8355,i__8357);lt.plugins.haskell.print_inline_error.call(null,editor,error);
{
var G__8372 = seq__8354;
var G__8373 = chunk__8355;
var G__8374 = count__8356;
var G__8375 = (i__8357 + 1);
seq__8354 = G__8372;
chunk__8355 = G__8373;
count__8356 = G__8374;
i__8357 = G__8375;
...
{var temp__4092__auto__ = cljs.core.seq.call(null,seq__8354);if(temp__4092__auto__)
{var seq__8354__$1 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,seq__8354__$1))
{var c__7486__auto__ = cljs.core.chunk_first.call(null,seq__8354__$1);{
var G__8376 = cljs.core.chunk_rest.call(null,seq__8354__$1);
var G__8377 = c__7486__auto__;
var G__8378 = cljs.core.count.call(null,c__7486__auto__);
var G__8379 = 0;
seq__8354 = G__8376;
chunk__8355 = G__8377;
count__8356 = G__8378;
...
{var error = cljs.core.first.call(null,seq__8354__$1);lt.plugins.haskell.print_inline_error.call(null,editor,error);
{
var G__8380 = cljs.core.next.call(null,seq__8354__$1);
var G__8381 = null;
var G__8382 = 0;
var G__8383 = 0;
seq__8354 = G__8380;
...
return (function (p1__8358_SHARP_,p2__8359_SHARP_){return cljs.core.get_in.call(null,cljs.core.deref.call(null,editor),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"haskell.result-fn","haskell.result-fn",3772146800)], null)).call(null,p1__8358_SHARP_,p2__8359_SHARP_);
});})(ghci))
...
lt.plugins.haskell.run_haskell = (function run_haskell(p__8360){var map__8362 = p__8360;var map__8362__$1 = ((cljs.core.seq_QMARK_.call(null,map__8362))?cljs.core.apply.call(null,cljs.core.hash_map,map__8362):map__8362);var info = map__8362__$1;var client = cljs.core.get.call(null,map__8362__$1,new cljs.core.Keyword(null,"client","client",3951159101));var name = cljs.core.get.call(null,map__8362__$1,new cljs.core.Keyword(null,"name","name",1017277949));var path = cljs.core.get.call(null,map__8362__$1,new cljs.core.Keyword(null,"path","path",1017337751));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.haskell","connecting-notifier","lt.plugins.haskell/connecting-notifier",4244447005),info);var client_id = lt.objs.clients.__GT_id.call(null,client);lt.object.merge_BANG_.call(null,client,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"port","port",1017351155),lt.objs.clients.tcp.port,new cljs.core.Keyword(null,"proc","proc",1017353928),obj], null));
...
lt.plugins.haskell.notify = (function notify(obj){var map__8364 = obj;var map__8364__$1 = ((cljs.core.seq_QMARK_.call(null,map__8364))?cljs.core.apply.call(null,cljs.core.hash_map,map__8364):map__8364);var client = cljs.core.get.call(null,map__8364__$1,new cljs.core.Keyword(null,"client","client",3951159101));var path = cljs.core.get.call(null,map__8364__$1,new cljs.core.Keyword(null,"path","path",1017337751));var haskell = cljs.core.get.call(null,map__8364__$1,new cljs.core.Keyword(null,"haskell","haskell",1711527270));if((cljs.core.not.call(null,haskell)) || (cljs.core.empty_QMARK_.call(null,haskell)))
...
lt.plugins.haskell.try_connect = (function try_connect(p__8365){var map__8367 = p__8365;var map__8367__$1 = ((cljs.core.seq_QMARK_.call(null,map__8367))?cljs.core.apply.call(null,cljs.core.hash_map,map__8367):map__8367);var info = cljs.core.get.call(null,map__8367__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"haskell.client","haskell.client",4292563063));lt.plugins.haskell.check_all.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",1017337751),path,new cljs.core.Keyword(null,"client","client",3951159101),client], null));
return client;
});
...
lt.plugins.haskell.send_api_command = (function send_api_command(event,command,data){var map__8369 = event;var map__8369__$1 = ((cljs.core.seq_QMARK_.call(null,map__8369))?cljs.core.apply.call(null,cljs.core.hash_map,map__8369):map__8369);var origin = cljs.core.get.call(null,map__8369__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__8369__$1,new cljs.core.Keyword(null,"info","info",1017141280));var client = new cljs.core.Keyword(null,"default","default",2558708147).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"client","client",3951159101).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,origin)));lt.objs.notifos.working.call(null,"");
...
lt.plugins.haskell.send_whole_file_command = (function send_whole_file_command(event,command){var map__8371 = event;var map__8371__$1 = ((cljs.core.seq_QMARK_.call(null,map__8371))?cljs.core.apply.call(null,cljs.core.hash_map,map__8371):map__8371);var origin = cljs.core.get.call(null,map__8371__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));return lt.plugins.haskell.send_api_command.call(null,event,command,lt.objs.tabs.__GT_path.call(null,origin));
});
